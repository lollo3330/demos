...
import { t as Continuously } from "./continuously-CBWOyNQH.js";
import { D as QueueMutable } from "./index-CGEkIDnm.js";
import { n as SimpleEventEmitter, r as ISimpleEventEmitter } from "./index-CWTNd_9a.js";
import { bn as Point, fn as Rect } from "./index-BkgVlV67.js";
import { l as NumberTracker } from "./index-BwC9AaPA.js";
import { i as Transitions, n as StateChangeEvent, r as StateMachineWithEvents } from "./state-machine-Cso9ri9w.js";
import { n as ManualCapturer } from "./index-DO5jnaPB.js";
 ...
 */
declare const analyserBasic: (onData: (freq: Float32Array, wave: Float32Array, analyser: AudioAnalyser) => void, opts?: Opts$2) => AudioAnalyser;
/**
 ...
 * @returns
 */
declare const analyserFrequency: (onData: (freq: Float32Array, analyser: AudioAnalyser) => void, opts?: Opts$2) => AudioAnalyser;
/**
 ...
 * @returns
 */
declare const analyserPeakLevel: (onData: (level: number, analyser: AudioAnalyser) => void, opts?: Opts$2) => AudioAnalyser;
/**
...
declare class AudioAnalyser {
  ...
  constructor(analyse: DataAnalyser, opts?: Opts$2);
  init(): void;
  get paused(): boolean;
...
declare namespace index_d_exports$2 {
  export { AudioAnalyser, AudioElements, AudioOscillatorOptions, AudioVisualiser, BasicAudio, BasicAudioElement, BasicAudioOscillator, DataAnalyser, Opts$2 as Opts, analyserBasic, analyserFrequency, analyserPeakLevel, createFromAudioElement, createOscillator };
}
...
declare class StringWriteBuffer {
   ...
   * @param opts Options
   */
  constructor(dataHandler: (data: string) => Promise<void>, opts?: Opts$1);
  /**
   * Close writer (async)
   */
  close(): Promise<void>;
...
declare namespace nordic_ble_device_d_exports {
  export { NordicBleDevice, Opts, defaultOpts };
}
...
declare namespace index_d_exports {
  export { index_d_exports$2 as Audio, BleDeviceOptions, nordic_ble_device_d_exports as Bluetooth, camera_d_exports as Camera, Codec, espruino_d_exports as Espruino, FrameProcessor, FrameProcessorOpts, FrameProcessorSources, GenericStateTransitions, IoDataEvent, IoEvents, JsonDataEvent, JsonDevice, JsonDeviceEvents, JsonDeviceOpts, index_d_exports$1 as Midi, ReconnectingOptions, ReconnectingWebsocket, ReconnectingWebsocketStates, serial_d_exports as Serial, StateChangeEvent, StringReceiveBuffer, StringWriteBuffer, Opts$1 as StringWriteBufferOpts, video_file_d_exports as VideoFile, genericStateTransitionsInstance, reconnectingWebsocket };
}
//#endregion
...
//# sourceMappingURL=index-BsZrgmVe.d.ts.map