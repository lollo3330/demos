import { A as MovingWindowOptions } from "./index-Z_1aDdMs.js";
 ...
 */
declare function isValid(possibleNumber: unknown): boolean;
//#endregion
 ...
 * const fn = interpolateBasic(0.1, 50, 100);
 * ```
 *
 ...
 * const fn = interpolateBasic(50, 100);
 *
 ...
 * @returns
 */
declare function interpolatorStepped(incrementAmount: number, a?: number, b?: number, startInterpolationAt?: number, options?: Partial<BasicInterpolateOptions>): (retargetB?: number, retargetA?: number) => number;
/**
 ...
 * @returns
 */
declare function interpolateAngle(amount: number, aRadians: number, bRadians: number, options?: Partial<BasicInterpolateOptions>): number;
//#endregion
 ...
 */
declare function rangeIsEqual(a: NumericRange | undefined, b: NumericRange | undefined): boolean;
/**
 ...
 */
declare function rangeIsWithin(a: NumericRange | undefined, b: NumericRange | undefined, exclusive?: boolean): boolean;
/**
 ...
 * @returns RangeStream
 */
declare function rangeStream(initWith?: NumericRange): RangeStream;
/**
...
declare namespace index_d_exports {
  export { BasicInterpolateOptions, bipolar_d_exports as Bipolar, BipolarWrapper, DifferenceKind, Kalman1dFilter, Kalman1dFilterOptions, MovingAverageNanOptions, MovingAverageOptions, normalise_d_exports as Normalise, NumberScaler, NumberScalerTwoWay, NumbersComputeOptions, NumbersComputeResult, NumericRange, RangeStream, applyToValues, average, averageWeigher, averageWeighted, clamp$1 as clamp, clampIndex, clamper, computeIsOutlier, count, differenceFromFixed, differenceFromLast, dotProduct, filterIterable, flip, getQuantile, interpolate, interpolateAngle, interpolatorStepped, interquartileRange, isApprox, isCloseToAny, isValid, kalman1dFilter, linearSpace, max, maxAbs, maxFast, maxIndex, mean, median, min, minFast, minIndex, movingAverage, movingAverageLight, movingAverageWithContext, noiseFilter, numberArrayCompute, numericPercent, numericRange, numericRangeRaw, proportion, quantiseEvery, rangeCompute, rangeInclusive, rangeInit, rangeIsEqual, rangeIsWithin, rangeMergeRange, rangeMergeValue, rangeScaler, rangeStream, round, scale, scaleClamped, scalePercent, scalePercentages, scaler, scalerNull, scalerPercent, scalerTwoWay, softmax, standardDeviation, thresholdAtLeast, total, totalFast, trackSimple, validNumbers, weight, wrap, wrapInteger, wrapRange };
}
//#endregion
export { interpolateAngle as $, maxFast as A, averageWeigher as At, normalise_d_exports as B, rangeScaler as C, differenceFromFixed as Ct, average as D, clampIndex as Dt, proportion as E, clamp$1 as Et, total as F, movingAverageWithContext as G, MovingAverageOptions as H, totalFast as I, computeIsOutlier as J, noiseFilter as K, validNumbers as L, min as M, mean as Mt, minFast as N, median as Nt, dotProduct as O, clamper as Ot, minIndex as P, applyToValues as Pt, interpolate as Q, weight as R, rangeMergeValue as S, DifferenceKind as St, quantiseEvery as T, count as Tt, movingAverage as U, MovingAverageNanOptions as V, movingAverageLight as W, interquartileRange as X, getQuantile as Y, BasicInterpolateOptions as Z, rangeCompute as _, numericRangeRaw as _t, trackSimple as a, NumbersComputeOptions as at, rangeIsWithin as b, rangeInclusive as bt, scale as c, RangeStream as ct, scalePercentages as d, kalman1dFilter as dt, interpolatorStepped as et, scaler as f, isApprox as ft, round as g, numericRange as gt, scalerTwoWay as h, numericPercent as ht, wrapRange as i, NumberScalerTwoWay as it, maxIndex as j, averageWeighted as jt, max as k, maxAbs as kt, scaleClamped as l, Kalman1dFilter as lt, scalerPercent as m, isValid as mt, wrap as n, BipolarWrapper as nt, standardDeviation as o, NumbersComputeResult as ot, scalerNull as p, isCloseToAny as pt, linearSpace as q, wrapInteger as r, NumberScaler as rt, softmax as s, NumericRange as st, index_d_exports as t, bipolar_d_exports as tt, scalePercent as u, Kalman1dFilterOptions as ut, rangeInit as v, flip as vt, rangeStream as w, differenceFromLast as wt, rangeMergeRange as x, thresholdAtLeast as xt, rangeIsEqual as y, filterIterable as yt, numberArrayCompute as z };
//# sourceMappingURL=index-pP284CPy.d.ts.map